...
const crearPrePedido = {
    postPrePedido: async <T>(
        ...
        const url = `${API_CONFIG.BASE_URL}/ec.com.infinity.modelo.prepedido`;
    ...
    crearSolicitud: async <T>(
        ...
        const url = `${API_CONFIG.BASE_URL}/ec.com.infinity.modelo.prepedido/crearSolicitud`;
        return sendPostRequest<T>(url, body);
    },
    ...
    crearyenviar: async <T>(
        ...
        const url = `${API_CONFIG.BASE_URL}/ec.com.infinity.modelo.prepedido/crearyenviar`;
        return sendPostRequest<T>(url, body);
    },
    ...
    enviarPetroecuador: async <T>(
        ...
        const url = `${API_CONFIG.BASE_URL}/ec.com.infinity.modelo.prepedido/envio`;
